...
<form action="/kategori/update/<?= $kategori['id'] ?>" method="post" class="bg-white shadow-md rounded p-6">
    <div class="mb-4">
        <label for="nama_kategori" class="block text-gray-700 font-semibold mb-2">Nama Kategori</label>
        <input type="text" name="nama_kategori" id="nama_kategori" value="<?= esc($kategori['nama_kategori']) ?>" required
